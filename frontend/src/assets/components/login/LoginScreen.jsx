...
const LoginScreen = () => {
	...
	return (
		<>
			{buttonToggle ? <Register onClick={() => setButtonToggle(!buttonToggle)} /> : null}
			<div className="login">
				<div className="login-greenbar">
					<div className="login-wplogo">
						<WhatsappIcon />
						<div>WHATSAPP WEB</div>
						<LoginButton onClick={() => setButtonToggle(!buttonToggle)} />
					</div>
				</div>
				<div className="login-modal">
					<div className="login-modal-header">
						<div className="login-modal-text">
							<h1>WhatsApp'ı bilgisayarınızda kullanmak için:</h1>
							<ol>
								...
								<li>
									<span>
										...
										seçeneğine dokunup <strong>Bağlı Cihazlar</strong>'ı seçin
									</span>
								</li>

								<li>
									<span>
										<strong>Cihaz Bağla </strong>seçeneğine dokunun
									</span>
								</li>
								<li>Telefonunuzu bu ekrana doğrultarak kodu tarayın</li>
							</ol>
						</div>
						<div className="login-modal-qr">
