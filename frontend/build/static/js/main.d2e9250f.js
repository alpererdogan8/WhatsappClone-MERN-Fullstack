/*! For license information please see main.d2e9250f.js.LICENSE.txt */
!(function () {
	'use strict';
	var e = {
			463: function (e, n, t) {
						...
						try {
							...
							e: {
								var o = e,
									...
									s = n;
								if (
									((n = Li), (i.flags |= 32768), null !== s && 'object' === typeof s && 'function' === typeof s.then)
								) {
									var c = s,
										f = i,
										d = f.tag;
	...
	!(function () {
		...
		var e = t(250),
			n = t(184);
		var r = function () {
			return (0, n.jsx)('div', { className: 'App', children: 'DeadPixel' });
		};
		e.createRoot(document.getElementById('root')).render((0, n.jsx)(r, {}));
	})();
})();
//# sourceMappingURL=main.d2e9250f.js.map
